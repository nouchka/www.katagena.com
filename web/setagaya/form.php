...
<?php
    ...
    $req = "SELECT ri.* FROM users INNER JOIN rights ri ON user_id = right_user WHERE right_project = " . $p_id .
        " AND user_login = '" . $_SESSION['username'] . "';";
...
<div class="form">
	<form class="form-horizontal" action="./save.php" method="post">
		<input type="hidden" name="action" value="task-name" /> <input
			type="hidden" name="p_id" value="<?php
