...
<input type="hidden" name="action" value="task-name"/>
...
$("select").change(function () {
    ...
    <div class="controls">
    <input type="text" id="inputTask" name="inputTask" placeholder="Task">
    </div>
    </div>
    <div class="control-group">
    <label class="control-label" for="inputCategory">Category</label>
    <div class="controls">
    <input type="text" id="inputCategory" name="inputCategory" placeholder="Category">
    </div>
    </div>
    <div class="control-group">
    <label class="control-label" for="inputHours">Hours</label>
    <div class="controls">
    <input type="text" id="inputHours" name="inputHours" placeholder="Hours">
    </div>
    </div>
    <div class="control-group">
    <div class="controls">
...
<div style="margin: 0;" class="btn-toolbar" id="user-rights">

</div>
<hr/>
<form class="form-horizontal" action="./save.php?action=add-user" method="post">
<fieldset>
<legend>Add an user to the planning</legend>
    <div class="control-group">
    <label class="control-label" for="u_name">Specify twitter username</label>
    <div class="controls">
    <input type="text" name="u_name" placeholder="twitter username">
    <input id="add-user-pid" type="hidden" name="p_id" value=""/>
    </div>
    </div>
    <div class="control-group">
    <div class="controls">
