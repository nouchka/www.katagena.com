...
if (isset ( $_GET ['t_id'] ) && $_GET ['t_id'] > 0) {
	...
	$result ['task'] = array (
			...
			'task_category' => utf8_encode ( $line ["task_category"] ),
			'task_time' => $line ["task_time"],
			'task_deadline' => $line ["task_deadline"],
			'task_lvl' => $line ["task_lvl"],
			'task_owner' => $line ["task_owner"],
	...
	while ( $line = mysqli_fetch_array ( $res ) ) {
		$result ['users'] [] = array (
				...
				'owner' => $line ['project_owner'],
				'project' => $line ['right_project'] 
		);
	}
